...
void dnaseq_lfbs_gpu(cudaStream_t& stream, float* nn_prior, int32_t* output, float* duration_probability, float* tail_factor, float* transition_probability,
    ...
    printf("Local focus beam search call parameters\n");
    printf("  lanunch with %d blocks\n", batch_size);
    printf("  lanunch with %d threads per block\n", threads_per_block);

    printf("  bacth_size: %d\n", batch_size);
    printf("  duration length: %d \n", duration_length);
    printf("  beamtail length: %d\n", beamtail_length);
    ...
    std::cout << "Time for beam search: " << time_spent << std::endl;
...
void dnaseq_beam_gpu(cudaStream_t& stream, float* nn_prior, int32_t* output, float* duration_probability, float* tail_factor, float* transition_probability,
    ...
    printf("Full beam search call parameters\n");
    printf("  lanunch with %d blocks\n", batch_size);
    printf("  lanunch with %d threads per block\n", threads_per_block);

    printf("  bacth_size: %d\n", batch_size);
    printf("  duration length: %d \n", duration_length);
    printf("  beamlist_length: %d\n", beamlist_length);
    printf("  sortlist_length: %d\n", sortlist_length);
    printf("  kmer length: %d\n", kmer_length);
    printf("  block length: %d\n", block_length);
...
void dnaseq_viterbi_gpu(cudaStream_t& stream, float* nn_prior, int32_t* output, float* duration_probability, float* tail_factor, float* transition_probability,
    ...
    printf("Viterbi call parameters\n");
    printf("  lanunch with %d blocks\n", batch_size);
    printf("  lanunch with %d threads per block\n", threads_per_block);
    ...
    clock_t end = clock();
    double time_spent = (double)(end - begin) / CLOCKS_PER_SEC;
    std::cout << "Time forViterbi: " << time_spent << std::endl;
